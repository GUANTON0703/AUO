...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        try:
            ...
            elif path=='/api/cache_status': self.send_json(cache_status())
...
<div class="fb">
  ...
  <span id="cache-info" style="margin-left:auto;font-size:11px;color:#888"></span>
  <button class="btn" onclick="forceRefresh()" style="background:#c94a00;margin-left:6px" title="清除 Cache 並從 DB 重新抓取最新資料">🔄 重新抓取</button>
</div>
<div class="main">
