...
excel_cache = {}
snapshot_lock = threading.Lock()  # Fix-10i: 剪貼簿序列鎖
...
def generate_snapshot_with_pywin32(file_path, sheet_name, row_num):
    ...
    try:
        ...
        # Fix-10k: 全部 COM 操作都在 snapshot_lock 內
        # 避免多 thread 跨 thread 呼叫 COM → RPC_E_WRONG_THREAD
        with snapshot_lock:
            print(f"   🔒 [Fix-10k] 取得 snapshot_lock...")
